...
const Hero = () => {
  return (
    ...
    >
      {/* Background visual effects - mantidos fixos */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-12 md:py-20 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* Coluna Esquerda: Texto Estático (Sem Motion para performance máxima) */}
          <div className="lg:col-span-7 flex flex-col justify-center text-left">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 text-blue-400 px-3.5 py-1.5 rounded-full text-xs font-bold tracking-wide uppercase mb-6 self-start">
              <Activity className="w-4 h-4 text-blue-500" />
              <span>Alta Performance &amp; Método GPS</span>
            </div>

            <h1 className="font-display font-black text-4xl sm:text-5xl md:text-6xl text-white italic tracking-tight uppercase leading-snug mb-6">
              MÉTODO, ESTRATÉGIA E{' '}
            ...
            <p className="text-zinc-300 text-lg md:text-xl font-normal leading-relaxed mb-8 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <a
                ...
                className="bg-orange-500 hover:bg-orange-600 text-white font-black text-lg py-4.5 px-8 rounded-2xl tracking-wider uppercase transition-all duration-300 flex items-center justify-center gap-3"
              >
          ...
          {/* Coluna Direita: Imagem Otimizada */}
